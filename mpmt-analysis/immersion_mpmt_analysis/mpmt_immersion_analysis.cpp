...
int main( int argc, char* argv[] ) {
	...
	TH1F *h17 = new TH1F("coincidence_charges_ratio_2", "Ratio Coincidence Charges 2 Channels",200,0,2*0.48828125);
	TH1F *h18 = new TH1F("coincidence_charges_ratio_4", "Ratio Coincidence Charges 4 Channels",200,0,2*0.48828125);
	
	int twoNum = 0;
	int fourNum = 0;

	for(int i = 0; i < tt[0]->GetEntries()-1; i++){
