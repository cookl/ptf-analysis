...
int main( int argc, char* argv[] ) {
    ...
    // Create histograms
    TH1F *laser_pulse_height     = new TH1F("ph-laser","Laser Pulse Height",200,0,0.000488*200*1000);
    TH1F *before_laser_height = new TH1F("ph-before","Pulse Height Before Laser",200,0,0.000488*200*1000);
    TH1F *after_laser_height = new TH1F("ph-after", "Pulse Height After Laser",200,0,0.000488*200*1000);
