...
int main( int argc, char* argv[] ) {
    ...
    // Create histograms
    TH1F *laser_pulse_height     = new TH1F("ph ~2000ns","No Laser Pulse Height",200,0,0.000488*200*1000);
    TH1F *before_laser_height = new TH1F("ph <2000ns","Pulse Height Before Laser",200,0,0.000488*200*1000);
    TH1F *after_laser_height = new TH1F("ph >2000ns", "Unscaled No Laser Pulse Height",200,0,0.000488*200*1000);
...
//    unscaled histograms
        ...
        legend->AddEntry(laser_pulse_height,"pulse height ~2000ns","l");
        legend->AddEntry(before_laser_height,"pulse height <2000ns","l");
        legend->AddEntry(after_laser_height,"pulse height >2000ns");
        legend->Draw();
