#ifndef __PTF_CONFIG__
#define __PTF_CONFIG__
...
#define PTF_CAEN_V1730_SAMPLE_RATE 500 // MS/s
#define PTF_CAEN_V1730_FULL_SCALE_RANGE 2.0 // Vpp
#define PTF_CAEN_V1730_RESOLUTION 14 // bits
