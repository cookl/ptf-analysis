#ifndef __WAVEFORMANALYSIS__
#define __WAVEFORMANALYSIS__
...
public:
  WaveformAnalysis( TFile * outfile,Wrapper & ptf, double errorbar, PTF::PMT & pmt, string config_file, bool savewf=false );
  ~WaveformAnalysis(){
